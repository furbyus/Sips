...
namespace Furbyus\Sips\Lib;

/**
  * Aes encryption (Only for Nabalia encrypt-decrypt process)
  * DEPRECATED in PHP > 7.0, it has to change the use of the mcrypt for the openssl or sodium libraries
 */
class AES {
